...
public class DFAMachineTest{
    ...
    @Test
    public void DFAMachine_should_not_recognise__00() throws IllegalCharException {
        State state1 = new State("q1");
        State state2 = new State("q2");
        state2.setFinalState(true);
    ...
    @Test
    public void DFAMachine_should_not_recognise__0000() throws IllegalCharException {
        State state1 = new State("q1");
        State state2 = new State("q2");
        state2.setFinalState(true);
